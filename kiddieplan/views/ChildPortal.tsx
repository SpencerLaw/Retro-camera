                    ...
                    >
                        <div className="flex items-center gap-4">
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                onClick={onLogout}
                                className="w-10 h-10 flex items-center justify-center bg-white/20 backdrop-blur-md rounded-2xl text-red-500 font-black shadow-sm border border-white/20 hover:bg-white/30 transition-all"
                                title="返回"
                            >
