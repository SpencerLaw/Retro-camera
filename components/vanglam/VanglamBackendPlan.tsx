...
const excludedScope = [
  ...
  '下载资料前填写联系方式、自动分组、自动提醒销售等高级规则。',
  '销售统计、下载统计、客户来源统计等报表看板。',
  '按颜色、工艺、克重、用途等多个条件筛选产品。',
  '根据场景自动推荐纸张、自动生成报价等功能。',
  '和客户现有 ERP、CRM、财务、仓库等第三方系统对接。',
];
...
const maintenanceRows = [
  ...
  ['按功能维护', '按单次功能报价', '新增页面、新增功能、新增接口、小程序能力扩展、多条件筛选、下载资料前填写联系方式、统计报表和第三方系统对接。'],
];
            ...
            <section id="price" className="vanglam-doc-section">
              ...
              <table className="vanglam-doc-table">
                <tbody>
                  ...
                  <tr>
                    <th>费用不包含</th>
                    <td>小程序前端开发、客户正式内容整理上传录入、报价下单库存审批等内部业务功能、多条件筛选、自动推荐和第三方系统对接。</td>
                  </tr>
                </tbody>
              </table>
            </section>
