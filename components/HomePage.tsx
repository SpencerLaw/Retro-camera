    ...
    <div className="w-full pb-8 relative">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 pt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 md:gap-8 lg:gap-6 px-4">
          ...
          {/* Tug of War - Blue/Red Battle */}
          <Link
            to="/tug-of-war"
            className="group relative bg-gradient-to-br from-[#4facfe] via-[#00f2fe] to-[#4facfe] rounded-[2.5rem] p-8 cursor-pointer transform transition-all duration-500 hover:scale-105 hover:-translate-y-4 shadow-[0_12px_30px_rgba(79,172,254,0.4)] border-[5px] border-white/90 hover:shadow-[0_20px_40px_rgba(79,172,254,0.6)] hover:rotate-2 block"
            style={{
              transformStyle: 'preserve-3d',
            }}
          >
            <div className="absolute -top-4 -right-4 text-3xl animate-bounce opacity-0 group-hover:opacity-100 transition-opacity" style={{ animationDuration: '1.5s' }}>⚔️</div>
            <div className="absolute -inset-3 bg-gradient-to-r from-[#4facfe] to-[#00f2fe] rounded-[2.5rem] blur-2xl opacity-0 group-hover:opacity-60 transition-opacity duration-500"></div>

            <div className="relative z-10 flex justify-center mb-6">
              <div
                className="w-36 h-36 bg-white rounded-full flex items-center justify-center shadow-[0_12px_24px_rgba(79,172,254,0.4)] transform group-hover:rotate-12 group-hover:scale-125 transition-all duration-500 border-[6px] border-[#4facfe]"
                style={{ transformStyle: 'preserve-3d' }}
              >
                <Trophy size={72} className="text-[#00f2fe] drop-shadow-lg" />
              </div>
            </div>

            <div className="relative z-10 text-center">
              <h2 className="font-bold text-4xl text-[#0072ff] mb-3 drop-shadow-[0_2px_8px_rgba(255,255,255,0.8)]">{t('home.tugOfWar.title')}</h2>
              <p className="text-base text-[#00a8ff] mb-4 font-semibold drop-shadow-[0_1px_4px_rgba(255,255,255,0.7)]">
                {t('home.tugOfWar.subtitle')}
              </p>
              <p className="text-sm text-[#0097e6] leading-relaxed font-medium drop-shadow-[0_1px_4px_rgba(255,255,255,0.6)]">
                {t('home.tugOfWar.description')}
              </p>
              <div className="mt-6 pt-6 border-t-[3px] border-white/70">
                <div className="inline-block px-6 py-3 bg-white text-[#4facfe] rounded-full text-base font-bold transform group-hover:scale-125 transition-transform duration-300 shadow-[0_4px_12px_rgba(79,172,254,0.4)] border-[3px] border-[#00f2fe] hover:bg-gradient-to-r hover:from-[#00f2fe] hover:to-white">
                  Enter → 🏆
                </div>
              </div>
            </div>
          ...
          <Link
            to="/juzimi"
            className="group relative bg-gradient-to-br from-[#F7F0E6] via-[#D6B47C] to-[#111111] rounded-[2.5rem] p-8 cursor-pointer transform transition-all duration-500 hover:scale-105 hover:-translate-y-4 shadow-[0_12px_30px_rgba(17,17,17,0.28)] border-[5px] border-white/90 hover:shadow-[0_20px_40px_rgba(17,17,17,0.45)] hover:rotate-2 block overflow-hidden"
            style={{
              transformStyle: 'preserve-3d',
            }}
          >
            <div className="absolute -top-4 -right-4 text-3xl animate-bounce opacity-0 group-hover:opacity-100 transition-opacity" style={{ animationDuration: '1.5s' }}>✒️</div>
            <div className="absolute -inset-3 bg-gradient-to-r from-[#D6B47C] to-[#111111] rounded-[2.5rem] blur-2xl opacity-0 group-hover:opacity-50 transition-opacity duration-500"></div>
            <div className="absolute inset-x-6 top-8 h-px bg-white/50" />
            <div className="absolute inset-x-6 bottom-8 h-px bg-white/35" />

            <div className="relative z-10 flex justify-center mb-6">
              <div
                className="w-36 h-36 bg-[#111111] rounded-full flex items-center justify-center shadow-[0_12px_24px_rgba(17,17,17,0.35)] transform group-hover:rotate-12 group-hover:scale-125 transition-all duration-500 border-[6px] border-[#F7F0E6]"
                style={{ transformStyle: 'preserve-3d' }}
              >
                <BookOpen size={72} className="text-[#D6B47C] drop-shadow-lg" />
              </div>
            </div>

            <div className="relative z-10 text-center">
              <h2 className="font-bold text-4xl text-white mb-3 drop-shadow-[0_2px_8px_rgba(0,0,0,0.45)]">句子迷</h2>
              <p className="text-base text-[#FFF7E8] mb-4 font-semibold drop-shadow-[0_1px_4px_rgba(0,0,0,0.35)]">
                杂志感句子展示
              </p>
              <p className="text-sm text-[#F7F0E6] leading-relaxed font-medium drop-shadow-[0_1px_4px_rgba(0,0,0,0.35)]">
                收藏值得停留的句子，用高级排版展示给孩子和课堂。
              </p>
              <div className="mt-6 pt-6 border-t-[3px] border-white/30">
                <div className="inline-block px-6 py-3 bg-white text-[#111111] rounded-full text-base font-bold transform group-hover:scale-125 transition-transform duration-300 shadow-[0_4px_12px_rgba(17,17,17,0.25)] border-[3px] border-[#D6B47C] hover:bg-gradient-to-r hover:from-[#F7F0E6] hover:to-white">
                  Enter → ✒️
                </div>
              </div>
            </div>
