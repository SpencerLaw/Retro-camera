                          ...
                          return (
                            <div className="trend-morning-tree-wrapper">
                              ...
                              <svg viewBox={`0 0 ${width} ${height}`} preserveAspectRatio="none" className="trend-morning-tree-svg">
                                ...
                                <path d={linePath} fill="none" stroke="#0096E1" strokeWidth="2.8" strokeLinecap="round" strokeLinejoin="round" className="trend-path-glow" />
                                <circle cx={pts[peakIdx].x} cy={pts[peakIdx].y} r="2.2" fill="#fff" />
                                <circle cx={pts[lowIdx].x} cy={pts[lowIdx].y} r="2.2" fill="#fff" />
                              </svg>
